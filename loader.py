...
from MODEL.NER.NER_TENSORFLOW.data_utils import create_dico, create_mapping, zero_digits
from MODEL.NER.NER_TENSORFLOW.data_utils import iob2, iob_iobes, get_seg_features
...
def augment_with_pretrained(dictionary, ext_emb_path, chars):
    ...
    `words` (typically the words in the development and test_text.txt sets.)
    """
